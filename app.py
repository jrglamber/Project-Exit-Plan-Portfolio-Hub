...
EXPECTED_SOURCE_BUILDS = {
    ...
    "bco": os.getenv("BCO_EXPECTED_BUILD", "0.8.13").strip(),
}
...
def validate_summary(key: str, payload: Any) -> Dict[str, Any]:
    ...
    return {
        ...
        "basket": {
            ...
            "high_water_live": bool(basket.get("high_water_live")),
            "high_water_monitor_interval_seconds": safe_float(basket.get("high_water_monitor_interval_seconds")),
